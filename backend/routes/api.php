...
Route::middleware(['auth:sanctum'])->prefix('rbac')->group(function () {
    ...
    Route::get('/roles', [UserRolePermissionController::class, 'getRoles']);
    Route::get('/permissions', [UserRolePermissionController::class, 'getPermissions'])->middleware('role:super_admin');
    Route::put('/roles/{role}', [UserRolePermissionController::class, 'updateRolePermissions'])->middleware('role:super_admin');
});
