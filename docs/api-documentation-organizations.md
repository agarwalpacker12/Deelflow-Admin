...
- `uuid` (string, read-only): The unique identifier for the organization.
...
- **Parameters:**
  - `organization` (integer, required): The ID of the organization.
  - `user` (integer, required): The ID of the user to remove.
- **Response:** A success message.
